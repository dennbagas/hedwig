...
func RunSweep(ctx context.Context, store database.Repository, tg telegrambot.Client, interval, expiry time.Duration, logger *zap.Logger) {
...
func sweep(ctx context.Context, store database.Repository, tg telegrambot.Client, expiry time.Duration, logger *zap.Logger) {
